...
/** Seed / fallback articles — ultra-clean technician KB (no client docs). */
export const KB_SEED_ARTICLES: {
  ...
  // ——— Service Procedures ———
  {
    title: "Device Setup Procedure",
    category: "Service Procedures",
    tags: ["setup", "workstation", "procedure", "quick-access"],
    content: `## Purpose
...
Escalate to a service manager if imaging fails twice or required access is missing.`,
  ...
  {
    title: "New User Onboarding Procedure",
    category: "Service Procedures",
    tags: ["onboarding", "user", "procedure", "quick-access"],
    content: `## Purpose
...
Escalate if HR / manager approval is missing or privileged access is requested.`,
  },
  {
    ...
    category: "Service Procedures",
    tags: ["offboarding", "user", "procedure"],
    content: `## Purpose
...
Escalate for executive accounts, legal holds, or suspected data risk.`,
  ...
  {
    title: "Printer Service Procedure",
    category: "Service Procedures",
    tags: ["printer", "procedure", "hardware"],
    content: `## Purpose
...
Escalate if the device stays unreachable after network checks or needs parts.`,
  ...
  {
    title: "Laptop Repair Procedure",
    category: "Service Procedures",
    tags: ["laptop", "repair", "procedure"],
    content: `## Purpose
...
Escalate for data-loss risk, liquid damage beyond scope, or suspected security incident.`,
  ...
  {
    title: "On-Site Visit Procedure",
    category: "Service Procedures",
    tags: ["onsite", "procedure", "field"],
    content: `## Purpose
...
Escalate immediately for safety concerns or Critical outages beyond local fix.`,
  ...
  {
    title: "Ticket Handling Procedure",
    category: "Service Procedures",
    tags: ["tickets", "sop", "procedure", "quick-access"],
    content: `## Purpose
...
Escalate for SLA risk, security incidents, or blocked access after two attempts.`,
  },
  {
    ...
    category: "Service Procedures",
    tags: ["password", "identity", "procedure", "quick-access"],
    content: `## Purpose
...
Escalate if identity cannot be verified or compromise is suspected.`,
  ...
  {
    title: "Software Install Procedure",
    category: "Service Procedures",
    tags: ["software", "install", "procedure"],
    content: `## Purpose
...
Escalate for unapproved software requests or deployment failures after two attempts.`,
  ...
  {
    title: "Patch Update Procedure",
    category: "Service Procedures",
    tags: ["patch", "updates", "procedure"],
    content: `## Purpose
...
Escalate for failed server patches or widespread update failures.`,
  },
  {
    ...
    category: "Service Procedures",
    tags: ["backup", "procedure", "recovery"],
    content: `## Purpose
...
Escalate any restore request or repeated job failures.`,
  ...
  {
    title: "Device Retirement Procedure",
    category: "Service Procedures",
    tags: ["retirement", "wipe", "procedure"],
    content: `## Purpose
...
Escalate for devices under legal hold or unclear ownership.`,
  ...
  // ——— Troubleshooting Guides ———
  {
    ...
    tags: ["printer", "offline", "troubleshooting", "quick-access"],
    content: `## Symptoms
...
Escalate if unreachable after network checks or hardware fault is confirmed.`,
  },
  {
    ...
    category: "Troubleshooting Guides",
    tags: ["email", "outlook", "troubleshooting", "quick-access"],
    content: `## Symptoms
...
Escalate for mailbox corruption, tenant-wide mail flow issues, or suspected compromise.`,
  },
  {
    ...
    category: "Troubleshooting Guides",
    tags: ["password", "identity", "troubleshooting", "quick-access"],
    content: `## Symptoms
- User locked out
- Forgotten password
- Password expired
...
Escalate if identity cannot be verified or account shows compromise indicators.`,
  ...
  {
    title: "VPN Setup & Failures",
    category: "Troubleshooting Guides",
    tags: ["vpn", "remote", "troubleshooting", "quick-access"],
    content: `## Symptoms
...
Escalate for gateway outages or profile changes that require admin approval.`,
  },
  {
    title: "MFA Issues",
    category: "Troubleshooting Guides",
    tags: ["mfa", "identity", "troubleshooting", "quick-access"],
    content: `## Symptoms
...
Escalate for failing disks, recurring malware, or business-critical app slowness.`,
  ...
  {
    title: "No Internet / Network Down",
    category: "Troubleshooting Guides",
...
Escalate for Feature Update rollbacks or many devices failing the same patch.`,
  ...
  {
    title: "Shared Drive Access Issues",
    category: "Troubleshooting Guides",
    tags: ["shares", "permissions", "troubleshooting"],
    content: `## Symptoms
...
Escalate for permission redesign requests or server-side share outages.`,
  ...
  {
    title: "Audio / Webcam Not Working",
    category: "Troubleshooting Guides",
    tags: ["audio", "webcam", "troubleshooting"],
    content: `## Symptoms
...
Escalate for hardware failure after driver reinstall or dock-related failures.`,
  ...
  {
    title: "Blue Screen / Unexpected Restart",
    category: "Troubleshooting Guides",
    tags: ["bsod", "crash", "troubleshooting"],
    content: `## Symptoms
- Blue screen error
- Sudden restarts
- Crash dumps present
...
Escalate for recurring BSODs, suspected memory failure, or data-loss risk.`,
  ...
  // ——— Tools & Software ———
  {
    ...
    tags: ["rmm", "tools", "remote"],
    content: `## What it is used for
...
- Script denied — request elevated approval`,
  ...
  {
    title: "PSA / Ticketing System",
    category: "Tools & Software",
    tags: ["psa", "tickets", "tools"],
    content: `## What it is used for
...
- Missing restore point — do not wipe until manager confirms`,
  },
  {
    title: "Antivirus / EDR",
    category: "Tools & Software",
    tags: ["antivirus", "edr", "security", "tools"],
    content: `## What it is used for
...
- Policy not applying — sync and reboot once`,
  ...
  {
    title: "Identity Admin Center",
    category: "Tools & Software",
    tags: ["identity", "entra", "tools", "mfa"],
    content: `## What it is used for
...
- License assignment delayed — wait and refresh`,
  ...
  {
    title: "Company Portal / MDM",
    category: "Tools & Software",
    tags: ["mdm", "intune", "tools", "enrollment"],
    content: `## What it is used for
...
- Duplicate entry — void / note before resubmitting`,
  ...
  // ——— Standards & Policies ———
  {
    ...
    category: "Standards & Policies",
    tags: ["standards", "naming", "policy"],
    content: `## Device names
...
- Rotate shared credentials after use when required`,
  ...
  {
    title: "Ticketing Expectations",
    category: "Standards & Policies",
    tags: ["tickets", "standards", "policy"],
    content: `## Expectations
...
- Attach evidence when it helps the next tech`,
  },
  {
    ...
    category: "Standards & Policies",
    tags: ["security", "policy", "standards"],
    content: `## Expectations
...
- Never bypass MFA or EDR for convenience`,
  },
  {
    ...
    category: "Standards & Policies",
    tags: ["communication", "standards", "policy"],
    content: `## Expectations
...
- Update the ticket and related docs`,
  ...
  {
    title: "Asset Handling Standards",
    category: "Standards & Policies",
    tags: ["assets", "hardware", "policy"],
    content: `## Expectations
...
- Follow legal hold instructions without wiping`,
  ...
  // ——— Templates & Forms ———
  {
    ...
    tags: ["checklist", "onboarding", "template", "quick-access"],
    content: `## New user checklist
...
- [ ] Ticket updated with completion notes`,
  },
  {
    ...
    category: "Templates & Forms",
    tags: ["checklist", "offboarding", "template"],
    content: `## Offboarding checklist
...
Keep entries short. Do not include pricing.`,
  ...
  {
    title: "Ticket Resolution Template",
    category: "Templates & Forms",
    tags: ["ticket", "resolution", "template"],
    content: `## Resolution template
- **Issue:**
- **Cause:**
- **Actions taken:**
- **Result:**
...
Use plain language. No pricing or contract details.`,
  ...
  {
    title: "On-Site Visit Checklist",
    category: "Templates & Forms",
    tags: ["onsite", "checklist", "template"],
    content: `## On-site visit checklist
...
- [ ] Ticket notes and time logged before leaving`,
  },
  {
    ...
    category: "Templates & Forms",
    tags: ["intake", "repair", "template"],
    content: `## Device intake
- **Ticket #:**
- **Asset tag / serial:**
- **Device type / model:**
- **Reported issue:**
...
Set asset status to In Repair after intake.`,
  ...
  {
    title: "Password Reset Verification Script",
    category: "Templates & Forms",
    tags: ["password", "verification", "template"],
...
Never reset based on email alone for privileged accounts.`,
  ...
  {
    title: "Incident Handoff Template",
    category: "Templates & Forms",
    tags: ["incident", "handoff", "template"],
...
Keep it short enough for the next tech to act immediately.`,
  ...
  {
    title: "Remote Session Notes Template",
    category: "Templates & Forms",
    tags: ["remote", "notes", "template"],
    content: `## Remote session notes
- **Ticket #:**
...
- **Follow-up:**`,
  ...
  {
    title: "Loaner Device Checklist",
    category: "Templates & Forms",
    tags: ["loaner", "checklist", "template"],
    content: `## Loaner device checklist
- [ ] Asset tag recorded
...
- [ ] On return: wipe and update asset status`,
  ...
  // ——— Quick Access ———
  {
    ...
    tags: ["quick-access", "index", "most-used"],
    content: `## Most-used guides
